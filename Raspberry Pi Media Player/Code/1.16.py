...
def getInfoVideos():
    ...
    try:
        ...
        messagebox.showerror("Error", "No video in Info Folder")
...
def getInfoImages():
    ...
    try:
        ...
        messagebox.showerror("Error", "No image in Info Folder")
...
def getFitnessVideos():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Video in Fitness Folder")
...
def getEventsVideos():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Video in Events Folder")
...
def getReligiousVideos():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Video in Religious Folder")
...
def getDiningImages():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Image in Dining Folder")
...
def getArchiveVideos():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Video in Archive Folder")
...
def getArchiveImages():
    ...
    try:
        ...
        messagebox.showerror("Error", "No Image in Fitness Folder")
...
def play_info(type):
    ...
    frame_video_info.pack()
    return
def play_fitness(type):
    objPlayer.play_fitness()
    frame_fitness.pack()
    myFrame_fitness.pack_forget()
    return
def play_events(type):
    objPlayer.play_events()
    frame_events.pack()
    return
def play_religious(type):
    objPlayer.play_religious()
    frame_religious.pack()
    return
def play_archive(type):
...
PLAY_vid_menu_info = ttk.Button(frame_info, text = "Play", command = play_info)
PLAY_vid_menu_info.grid(row = 2, column = 2, padx = 10, pady = (100, 10))

MENU_vid_info = OptionMenu(frame_info, VideoOptionVal_info, *videosList_info)
MENU_vid_info.grid(row = 1, column = 3, padx = 10, pady = (10,10))

LABEL_vid_info = Label(frame_info, text = "Choose Video: ", font = ("Arial", 15))
...
PLAY_vid_menu_fitness = ttk.Button(frame_fitness, text = "Play", command = play_fitness)
PLAY_vid_menu_fitness.grid(row = 2, column = 2, padx = 10, pady = (100, 10))

MENU_vid_fitness = OptionMenu(frame_fitness, VideoOptionVal_fitness, *videosList_fitness)
MENU_vid_fitness.grid(row = 1, column = 3, padx = 10, pady = (10,10))

LABEL_vid_fitness = Label(frame_fitness, text = "Choose Video: ", font = ("Arial", 15))
LABEL_vid_fitness.grid(row = 1, column = 1, padx = (100, 20), pady = (10,10))

Back_vid_fitness = ttk.Button(frame_fitness, text = "Back", command = lambda: back_fitness('v'))
Back_vid_fitness.grid(row = 0, column = 0, padx = 10, pady = (300 ,10))


#events GUI

PLAY_vid_menu_events = ttk.Button(frame_events, text = "Play", command = play_events)
PLAY_vid_menu_events.grid(row = 2, column = 2, padx = 10, pady = (100, 10))

MENU_vid_events = OptionMenu(frame_events, VideoOptionVal_events, *videosList_events)
MENU_vid_events.grid(row = 1, column = 3, padx = 10, pady = (10,10))

LABEL_vid_events = Label(frame_events, text = "Choose Video: ", font = ("Arial", 15))
LABEL_vid_events.grid(row = 1, column = 1, padx = (100, 20), pady = (10,10))

Back_vid_events = ttk.Button(frame_events, text = "Back", command = lambda: back_events('v'))
Back_vid_events.grid(row = 0, column = 0, padx = 10, pady = (300 ,10))

#religious GUI

PLAY_vid_menu_religious = ttk.Button(frame_religious, text = "Play", command = play_religious)
PLAY_vid_menu_religious.grid(row = 2, column = 2, padx = 10, pady = (100, 10))

MENU_vid_religious = OptionMenu(frame_religious, VideoOptionVal_religious, *videosList_religious)
MENU_vid_religious.grid(row = 1, column = 3, padx = 10, pady = (10,10))

LABEL_vid_religious = Label(frame_religious, text = "Choose Video: ", font = ("Arial", 15))
LABEL_vid_religious.grid(row = 1, column = 1, padx = (100, 20), pady = (10,10))

Back_vid_religious = ttk.Button(frame_religious, text = "Back", command = lambda: back_religious('v'))
...
MENU_img_dining = OptionMenu(frame_dining, ImageOptionVal_dining, *imagesList_dining)
...
PLAY_vid_menu_archive = ttk.Button(frame_archive, text = "Play", command = play_archive)
PLAY_vid_menu_archive.grid(row = 2, column = 2, padx = 10, pady = (100, 10))

MENU_vid_archive = OptionMenu(frame_archive, VideoOptionVal_archive, *videosList_archive)
MENU_vid_archive.grid(row = 1, column = 3, padx = 10, pady = (10,10))

LABEL_vid_archive = Label(frame_archive, text = "Choose Video: ", font = ("Arial", 15))
LABEL_vid_archive.grid(row = 1, column = 1, padx = (100, 20), pady = (10,10))

Back_vid_archive = ttk.Button(frame_archive, text = "Back", command = lambda: back_archive('v'))
