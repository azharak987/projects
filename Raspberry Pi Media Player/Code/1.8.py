...
#guiWindow.overrideredirect(True)
#guiWindow.geometry("{0}x{1}+0+0".format(guiWindow.winfo_screenwidth(), guiWindow.winfo_screenheight()))
...
def getStorageVideos(location):
    if location == "default":
        ...
        myVideos = []
        #You can change the location of videos to any other here
        for file in glob2.glob("/home/pi/"+location+"/*.mp4"):
            myVideos.append(file)
        for items in myVideos:
            x = re.split("\/", items, 4)
            videosList.append(x[4])
...
def getStorageImages(location):
    if location == "default":
        ...
        myImages = []
        #You can change the location of images to any other here
        for file in glob2.glob("/home/pi/"+location+"/*.jpg"):
            myImages.append(file)
        for items in myImages:
            x = re.split("\/", items, 4)
            imagesList.append(x[4])
...
def mainFrameFtn(option):
    if option == "info":
        ...
        myFrame.pack()
        getStorageVideos("Info")
        getStorageImages("Info")
        
    elif option == "fitness":
        mainFrame.pack_forget()
        myFrame.pack()
        getStorageVideos("Fitness")
        getStorageImages("Fitness")
        
    elif option == "events":
        mainFrame.pack_forget()
        myFrame.pack()
        getStorageVideos("Events")
        getStorageImages("Events")
        
    elif option == "religious":
        mainFrame.pack_forget()
        myFrame.pack()
        getStorageVideos("Religious")
        getStorageImages("Religious")
        
    elif option == "dining":
        mainFrame.pack_forget()
        myFrame.pack()
        getStorageVideos("Dining")
        getStorageImages("Dining")
    elif option == "archive":
        mainFrame.pack_forget()
        myFrame.pack()
        getStorageVideos("Archive")
        getStorageImages("Archive")
getStorageVideos("default")
getStorageImages("default")
